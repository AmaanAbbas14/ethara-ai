...
5. Railway will use the included railway.json file with:
...
This project uses SQLite. On Railway, normal service storage is ephemeral, so SQLite data will be lost on redeploy unless you attach a persistent Volume. The app automatically uses RAILWAY_VOLUME_MOUNT_PATH when Railway provides it.
